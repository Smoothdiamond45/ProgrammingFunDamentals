...
public class Driver {
    ...
    private void exercise4() {
        ...
        for (int i = 0; i<10 ; i++) {
            System.out.println("Wage at index " + i  + " is: " + wages[i]);
        }
    }
    ...
    private void exercise6() {
        ...
        for (int i = 0; i<10 ; i++) {
            if (wages[i] > limit ) {
                wages[i] = wages[i] - (wages[i] * reduction ) ;
            }
        }
    ...
    private void exercise7() {
        ...
        System.out.println("Average Wage = " + (total / wages.length) );
    }
    ...
    private void exercise8() {
        ...
        double largestWage  = wages[0];
        
        for (int i = 0; i<size ; i++) {
            if (wages[i] > largestWage){
                largestWage = wages[i];
            }
        }
    ...
    private void exercise9() {
        ...
        for (int i = 0; i<size ; i++) {
            if (wages[i] > wages[largestWageIndex]){
                largestWageIndex = i;
            }
        }
        System.out.println("Largest Wage = " + wages[largestWageIndex]
